...
const artists = [
  { name: "Djonga", genre: "Rap/Hip Hop", image: "/images/artist-1.jpg" },
  { name: "Alceu Valença", genre: "MPB/Forró", image: "/images/artist-2.jpg" },
  { name: "Jorge Aragão", genre: "Samba/Pagode", image: "/images/artist-3.jpg" },
  { name: "Vanessa da Mata", genre: "MPB/Pop", image: "/images/artist-4.jpg" },
  { name: "Paralamas do Sucesso", genre: "Rock/Pop Rock", image: "/images/artist-5.jpg" },
  { name: "Nando Reis", genre: "MPB/Rock", image: "/images/artist-6.jpg" },
] as const;

export default function ArtistsSection() {
  return (
    <section id="artistas" className="bg-backstage-light-gray py-20 text-white">
      <div className="container mx-auto max-w-6xl px-4">
        <header className="mb-12 text-center">
          <h2 className="mb-2 text-3xl font-bold">
            Nossos <span className="color-backstage-orange">Artistas</span>
          </h2>
