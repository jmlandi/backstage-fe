    ...
    <section id="inicio" className="relative flex min-h-screen items-center justify-center overflow-hidden bg-black text-white">
      ...
      <div className="relative z-10 mx-auto max-w-4xl px-4 text-center md:opacity-5 hover:opacity-100 transition-all">
        ...
        <div className="flex flex-wrap justify-center gap-4">
          <a href="#shows" className="rounded-full bg-[#df2930] border-1 border-[#df2930] px-6 py-3 font-semibold text-white transition hover:bg-black">
            Ver Próximos Shows
          </a>
          <a href="#bio" className="rounded-full border-2 border-white/30 px-6 py-3 font-semibold text-white transition bg-none hover:bg-white/10">
      ...
      {/* Scroll indicator */}
      <div ref={indicatorRef} className="absolute bottom-10 flex flex-col items-center opacity-70 transition-all">
        <svg
          width="32"
          height="32"
          viewBox="0 0 32 32"
